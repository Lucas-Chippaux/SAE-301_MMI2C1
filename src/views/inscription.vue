<template>
    <div class="login-container flex flex-col items-center justify-center mt-16 mb-24">
      ...
      <!-- Section Nom -->
      <input type="text" id="nom" placeholder="Nom" class="rounded-full px-10 py-2 border-2 mb-2 text-xl" />

      <!-- Section Prénom -->
      <input type="text" id="prenom" placeholder="Prénom" class="rounded-full px-10 py-2 border-2 mb-2 text-xl" />
  
      <!-- Section E-mail -->
      <input type="email" id="email" placeholder="E-mail" class="rounded-full px-10 py-2 border-2 mb-2 text-xl" />
  
      <!-- Section Mot de passe -->
      <input type="password" id="password" placeholder="Mot de passe" class="rounded-full px-10 py-2 border-2 mb-2 text-xl" />
